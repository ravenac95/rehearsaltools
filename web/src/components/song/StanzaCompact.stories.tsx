...
const meta = {
  ...
  args: { stanza: base, effectiveBpm: 120, effectiveNote: "q", bpmInherited: true, noteInherited: true },
} satisfies Meta<typeof StanzaCompact>;

export default meta;
type Story = StoryObj<typeof meta>;

export const InheritedBpm: Story = { args: { bpmInherited: true, noteInherited: true } };
export const OverriddenBpm: Story = { args: { bpmInherited: false, noteInherited: true, stanza: { ...base, bpm: 140 }, effectiveBpm: 140 } };
export const OverriddenNote: Story = { args: { bpmInherited: true, noteInherited: false, effectiveNote: "h", stanza: { ...base, note: "h" } } };

...
// Fixed pull-up drawer showing take/discussion pills and End Rehearsal button.

import { useStore } from "../../store";

export function PlaybackDrawer() {
  const takes = useStore((s) => s.takes);
  const playbackDrawerOpen = useStore((s) => s.playbackDrawerOpen);
  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents: (hasTakes || playbackDrawerOpen) ? "auto" : "none",
    ...
    >
      ...
      <div
        ...
        onClick={() => setPlaybackDrawerOpen(!playbackDrawerOpen)}
        style={{
          display: "flex",
          alignItems: "center",
      ...
      <div style={{
        ...
        {/* Playback status bar */}
        {rehearsalStatus === "playback" && currentTakeIdx !== null && takes[currentTakeIdx] && (
          <div
          ...
          {takes.map((take, idx) => {
            ...
            return (
              <button
                ...
                onClick={() => selectTakeForPlayback(idx)}
                style={{
                  padding: "6px 14px",
                  borderRadius: "var(--radius-pill)",
                  fontSize: 13,
